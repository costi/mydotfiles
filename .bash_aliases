...
alias tail_pg='tail -f /usr/local/var/postgres/server.log'

export RB_INDEX_FILE=~/rb_files_cache
alias rehash_index="find /export/comp/stable -type f | grep -v rb_files | egrep -i '(rake|spec|rb|yml|tpl|txt)' > $RB_INDEX_FILE"
